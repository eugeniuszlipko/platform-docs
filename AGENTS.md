...
| Admin homepage curation (Avocado Kiss) | platform-docs/admin-panel/home-avocado-kiss.md | Curating the Avocado Kiss homepage (`home_slots`, Editor's Picks) — lives in Pages → Homepage |
